	 ...
	 <div class="container">
        ...
        <div class="panel-body"style="background-color:#aceace;margin-top: 0%;padding-bottom: 5px;border-radius: 15px 15px 15px 15px;height: 100%;width: 100%;">
             <div class="panel-heading">
                <h2 class="panel-title" style="text-align: center;font-size: 30px;"><b> Fill in House  details below <b></h2><br><br>
                    </div>
...
<!-- <form action="index.php" method="post"> -->
  ...
  <div class="form-group">
     <div class="form-group">
      <label for="inputname"class="col-sm-3 control-label">Rental Name</label>
      <div class="col-sm-6">
 ...
 <div class="form-group">
<label for="inputname"class="col-sm-3 control-label">House Type</label>
<div class="col-sm-6">
<select name="thouse" class="col-sm-12">
<option value="2-Bedroom">2-Bedroom </option>
<option value="Nairobi-Nakuru">1-Bedroom </option>
<option value="1-Bedroom ">Bedsitter </option>
<option value="Single">Single </option>
</select><br>
  </div>
 </div>
  <div class="form-group">
<label for="inputname"class="col-sm-3 control-label">Rent Amount</label>
<div class="col-sm-6">
  <input type="text" class="form-control" name="amount" placeholder=" for example 15000" required="true">
      </div>
 </div>
   <div class="form-group">
<label for="inputname"class="col-sm-3 control-label">Check in Montht</label>
<div class="col-sm-6">
...
<option value="December">December </option>
  ...
  <div class="form-group">
<label for="inputname"class="col-sm-3 control-label">Number of rooms</label>
<div class="col-sm-6">
...
require('dbconn.php');
 ...
 if(isset($_POST['submit'])){
  ...
  $rooms=$_POST['rooms'];
   ...
   $query="INSERT INTO  `houses` .`vehicle` (`name`,`location`,`model`,`amount`,`checkin`,`rooms`) VALUES('$name','$location','$model','$amount','$checkin','$rooms')";


if(mysqli_query($conn,$query)==TRUE) {
  echo "House Registered succesfully";
    echo "<br>";
