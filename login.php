...
switch ($Userrole) {
      case 'Admin':
      {
        $loginsql="SELECT * FROM `custodian` WHERE useremail='$username'";
          ...
          if ($loginresult) {
            if (mysqli_num_rows($loginresult)==1) {
             ...
             header("Location:login.php?error=Username and Password do not match");
            }
          }
        break;
      }
      case 'User':
      {
        $loginsql="SELECT * FROM `farmer` WHERE e_mail='$username'";
          $loginresult=mysqli_query($conn,$loginsql);
          if ($loginresult) {
            if (mysqli_num_rows($loginresult)==1) {
...
<script src="bootstrap/scripts/bootstrap.min.js"></script>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
     ...
     <a href="home.php" class="btn btn-info" role="button">Back</a><br><br><br>
<body>
    
   <div class="container" style="padding-top: 2%;padding-bottom: 10%;width: 25%; height:70%;border-radius: 15px 15px 15px 15px;background-color:#90EE90;margin-top:50px;" >

           
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="background-color:#90EE90;height:60px;">
                        <h3 class="panel-title"style="color:white;">Farmer Login</h3><br><br>
                    </div>
         ...
         <i class="glyphicon glyphicon-lock form-control-feedback"></i>
                  ...
                  <button type="submit" class="btn btn-success btn btn-block" id="login" name="btn-save"> login</button> 
                </div>
                

   </form>
                  <a href="regist.php" class="btn btn-default btn btn-block" role="button">Register Account</a>
