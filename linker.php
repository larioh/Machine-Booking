<?php
  ...
  if(!isset($_SESSION['applicantusername'])){
    header("Location:home.php?ref=Please Login First");
    }
     ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <!-- Navbar content -->
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-centre">
                    <li>
                        <a href="vehicles.php">View Tractors</a>
                    </li>
                    <li>
                        <a  href="profile.php">My bookings</a>
                    </li>
                    <li>
                        <a  href="farm_chat.php">Chat</a>
                    </li>
                    <li>
                        <a  href="#">FAQ</a>
                    </li>
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             ...
             <?php
                 $username=$_SESSION['applicantusername'];
                  $sql = "SELECT * FROM farmer where e_mail='$username'";
