...
require('dbconn.php');
  ...
  $salt = $hash["salt"];
      ...
      $insertaccountsql="INSERT INTO `farm_machines`.`tractor_owner` (`n_ame`, `id_no`, `e_mail`, `p_assword`) VALUES ( '$n_ame', '$id_no', '$e_mail','$encrypted')";
      $insertuserrolesql="INSERT INTO `farm_machines`.`userroles` ( `username`, `Userrole`,`id_no`) VALUES ('$e_mail', 'User','$id_no')";
