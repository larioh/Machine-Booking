<?php
  ...
  if(!isset($_SESSION['applicantusername'])){
    header("Location:login.php?ref=Please Login First");
    }
     ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <!-- Navbar content -->
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-centre">
                    <li>
                        <a href="index.php">My farmers's List</a>
                    </li>
                    <li>
                        <a  href="profile.php">View My Machines</a>
                    </li>
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             ...
             <?php
                 $username=$_SESSION['applicantusername'];
                  $sql = "SELECT * FROM tractor_owner where e_mail='$username'";
